...
# -*- coding: utf-8 -*-
#
# lanbilling-addresses documentation build configuration file, created by
# sphinx-quickstart on Wed Aug 24 15:02:58 2016.
#
...
project = 'lanbilling-addresses'
copyright = '2017, Ildar Gafurov'
...
htmlhelp_basename = 'lanbilling-addressesdoc'
...
latex_documents = [
	(master_doc, 'lanbilling-addresses.tex', 'lanbilling-addresses Documentation',
...
man_pages = [
	(master_doc, 'lanbilling-addresses', 'lanbilling-addresses Documentation',
	[author], 1)
]
...
texinfo_documents = [
	(master_doc, 'lanbilling-addresses', 'lanbilling-addresses Documentation',
	author, 'lanbilling-addresses', 'One line description of project.',
	'Miscellaneous'),
]
...
main(['-e', '-o', os.path.join(sphinx_dir, 'api'), os.path.join(os.path.dirname(__file__), '..', '..', 'lanbilling_addresses')])
